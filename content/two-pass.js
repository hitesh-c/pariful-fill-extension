(() => {
  ...
  function labelForControl(control) {
    ...
    const parent = control.closest("label, [data-testid='question'], .QuestionnaireForm_question__gsqZj");
  ...
  function extractQuestions() {
    ...
    for (const control of controls) {
      ...
      const parent = control.closest("[data-testid='question'], .QuestionnaireForm_question__gsqZj, label");
